...
BotonRegistrar.addEventListener("click",function(){
    ...
    fetch("http://tpallee.orgfree.com/registro.php", {
...
botonIngresar.addEventListener("click",function(){
    ...
    fetch("http://tpallee.orgfree.com/ingreso.php", {
        method: 'POST', //*GET, POST,PUT, DELETE, ETC.
        body: datosI
    })
    .then(function(response){
...
enviarM.addEventListener("click",function(){
    ...
    fetch("http://tpallee.orgfree.com/guardarMensaje.php", {
        method: 'POST', //*GET, POST,PUT, DELETE, ETC.
        body: datos
    })
    .then (function(response){
...
function leerM(){
    ...
    fetch("http://tpallee.orgfree.com/leerMensajes.php", {
        method: 'POST', //*GET, POST,PUT, DELETE, ETC.
        body: datosLM
    })
    .then (function(response){
